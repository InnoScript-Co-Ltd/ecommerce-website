            ...
            <>
                <div className=" w-full h-full relative overflow-hidden">

                    {
                        loading === false && productDetail !== null && productDetail !== undefined && (
                            <Image
                                src={`${endpoints.image}/${productDetail?.header_bg.image}`}
                    ...
                    <div className=" w-[300px] md:w-[600px] !text-white absolute left-[50%] top-[50%] -translate-x-[50%] -translate-y-[50%]">
                        ...
                        <div
                            className=" text-center font-normal text-[14px] leading-[25px] md:leading-[19px]"
                ...
                <div style={{
                    ...
                    <div className=" w-full lg:w-[40%] text-white">
                        <div
                            className=" font-normal text-[20px] md:text-[49.9px] md:leading-[59px]"
                ...
                <div className=" w-full h-full relative overflow-hidden">
                    ...
                    <div className=" w-[300px] md:w-[700px] lg:w-[1100px] h-auto lg:h-[400px] px-[10px] md:px-[50px] py-[30px] text-white absolute left-[50%] top-[50%] -translate-x-[50%] -translate-y-[50%]">
                        ...
                        <div
                            className=" font-normal text-[14px] text-center md:text-[39px] md:leading-[46px] !text-white"
                ...
                <div style={{
                    ...
                    <div className=" w-[380px] md:w-[600px] px-[30px] py-[30px]">
                        ...
                        <div
                            className=" font-normal text-[20px] md:text-[39px] leading-[30px] md:leading-[46px]"
